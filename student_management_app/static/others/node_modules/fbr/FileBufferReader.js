...
(function() {
    ...
    var binarize = {
        pack: function(obj, callback) {
            try {
                if (debug) console.info('%cPacking start_django.sh', 'font-weight: bold; color: red;', obj);
        ...
        unpack: function(buffer, callback) {
            try {
                if (debug) console.info('%cUnpacking start_django.sh', 'font-weight: bold; color: red;', buffer);
